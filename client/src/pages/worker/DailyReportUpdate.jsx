    ...
    return (
        <div className='mt-3 sm:mt-4 md:mt-5'>
            <div className='flex justify-between p-4 mt-4 mb-6'>
                ...
                <Button onClick={() => { setNewReport((prev) => !prev) }} style={{ display: "flex", alignItems: "center", gap: "4px" }} type="primary">
                    <TbReportMedical />
                    New Report
                </Button>
            </div>

            <div className={`${newReport ? " visible" : " hidden"} px-2 mt-3 mb-9 w-full border bg-white rounded`}>
